            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="company-logo">
                        ...
                        <p class="footer-desc mt-3">Every single day, SM touches the lives of millions of people through its stores, malls, banks, hotels and leisure facilities. Now, Filipinos can live in style, comfort, and convenience with SM Development Corporation</p>
                    </div>
                ...
                <div class="col-md-3">
                    <h1 class="heading footer-heading">Quick Links</h1>
                ...
                <div class="col-md-3">
                    <h1 class="heading footer-heading">Disclaimer</h1>
                    <p class="footer-desc mt-3">To promote SMDC Projects and increase Sales and Marketing of SMDC Condominiums, all information stated are intended to give a general overview of the project only and does not constitute any part of an offer or contract. www.smdc.com is the official website of SMDC.</p>
                </div>
            </div>
