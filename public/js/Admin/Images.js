$(document).ready(function () {
    ...
    $(".add_form input[name='imgs[]'], .upd_form input[name=img]").change(function () { 
...
var fk = sessionStorage.getItem("imgs_fk")
                ...
                for (var record of records) {
                    ...
                    for (var key of keys) {
                        ...
                        if (key == "action") {
                            ...
                            html = `<img src='/uploads/Properties/Images/${record[key]}'></img>`
                        }
                        else {
                            html = record[key]
                        }
